...
# min_max = get_normalization('kddcup.data_10_percent_corrected_unique')
# train = pd.read_csv('kddcup.data_10_percent_corrected_unique', header=None)
# train = normalize(train, min_max)
# train.to_csv('kddcup.data_10_percent_corrected_normalized', header=False, index=False)
#
...
intervals = get_intervals('kddcup.data_10_percent_corrected_unique')
