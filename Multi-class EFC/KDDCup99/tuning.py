...
train = pd.read_csv("Data/Encoded/Normalized-Discretized/X_train", header=None).astype('int')
train_labels =  pd.read_csv("Data/Encoded/Normalized-Discretized/y_train", squeeze=True, header=None).astype('int')
print(np.unique(train_labels, return_counts=True))
print(train_labels.shape[0])

validation = pd.read_csv("Data/Encoded/Normalized-Discretized/X_validation", header=None).astype('int')
validation_labels =  pd.read_csv("Data/Encoded/Normalized-Discretized/y_validation", squeeze=True, header=None).astype('int')
