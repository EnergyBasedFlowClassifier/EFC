...
for fold in range(1,6):
    ...
    proto = dict[2]
    reader = pd.read_csv("5-fold_sets/Non_discretized/Sets{}/reduced_train.csv".format(fold), chunksize=2000000, header=None)
    for chunk in reader:
    ...
    reader = pd.read_csv("5-fold_sets/Non_discretized/Sets{}/test.csv".format(fold), chunksize=2000000, header=None)
    for chunk in reader:
        data = encode(chunk, proto)
