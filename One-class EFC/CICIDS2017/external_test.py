...
for sets in range(1,11):
    files = ['Friday-WorkingHours-Afternoon-DDos.pcap_ISCX','Wednesday-workingHours.pcap_ISCX','Join_files']
    for file in files:
        train_file = file
        ...
        np.save("External_test/Results/Training_{}/Sets{}/ANN.npy".format(train_file, sets), np.array(mlp_list))
